...
file_put_contents("start.txt", "START Update", FILE_APPEND);
// Конец настроек
...
curl_setopt_array($ch, [
	CURLOPT_FILE => $fp,
	CURLOPT_HTTPHEADER => file_exists($last_updated_file)
		? ["If-Modified-Since: " . file_get_contents($last_updated_file)]
		: [],
]);
